#!/bin/bash
# Cleanup: MRC Static→Dynamic Migration (True Multi-Cluster, Secured)
...
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}  MRC Static→Dynamic Migration - Cleanup${NC}"
...
# ============================================================
print_step "Phase 2: Delete Keycloak (Central Identity Provider)"
...
# ============================================================
# Phase 3: Delete operator and infrastructure
# ============================================================
print_step "Phase 3: Delete operator and infrastructure"
...
# ============================================================
print_step "Phase 4: Delete namespaces"
...
# ============================================================
print_step "Phase 5: Clean up generated certificates"
if [[ -d "$CERT_DIR" ]]; then
