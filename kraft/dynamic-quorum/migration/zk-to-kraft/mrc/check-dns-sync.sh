...
# Covers: ZooKeeper, KRaft controllers, Kafka external, Kafka replication, Keycloak
# Modes:
...
usage() {
    ...
    echo "  - ZooKeeper (6 endpoints: 3 central + 3 east)"
...
run_checks() {
    ...
    check_endpoint "zk-central0" "zookeeper-0-lb" "$REGION1_NS" "zk-central0" "$interactive"
    check_endpoint "zk-central1" "zookeeper-1-lb" "$REGION1_NS" "zk-central1" "$interactive"
    check_endpoint "zk-central2" "zookeeper-2-lb" "$REGION1_NS" "zk-central2" "$interactive"
    check_endpoint "zk-east0" "zookeeper-0-lb" "$REGION2_NS" "zk-east0" "$interactive"
    check_endpoint "zk-east1" "zookeeper-1-lb" "$REGION2_NS" "zk-east1" "$interactive"
    check_endpoint "zk-east2" "zookeeper-2-lb" "$REGION2_NS" "zk-east2" "$interactive"
