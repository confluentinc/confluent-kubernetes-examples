...
```bash
export TUTORIAL_HOME=<Tutorial directory>/kraft/dynamic-quorum/migration/zk-to-kraft/single-cluster
```
...
**Direct-to-controller APIs blocked**: `UnsupportedVersionException`. Causes: CP 7.9.0 (upgrade to 7.9.6), missing IBP 3.9 annotation, or not yet in DUAL_WRITE phase.
