# Provision and Configure Oracle Database 21c Enterprise Edition with XStream Out Interface
...
<!---
Your SSO Username is: KAPPUKUTTAN@CONFLUENT.IO
ivbccwTjoD5fmcb=q8ucwK

docker login container-registry.oracle.com

kubectl create secret docker-registry oracle-container-registry-secret \
  --docker-server=container-registry.oracle.com \
  --docker-username='KAPPUKUTTAN@CONFLUENT.IO' \
  --docker-password='ivbccwTjoD5fmcb=q8ucwK' \
  --docker-email='KAPPUKUTTAN@CONFLUENT.IO' \
  -n ${ORACLE_NS}
-->
